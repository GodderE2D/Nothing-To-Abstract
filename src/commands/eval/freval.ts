...
export class FrevCommand extends Command {
  public constructor(context: Command.Context, options: Command.Options) {
    super(context, {
      ...options,
      name: "freval",
      description: "Evaluate JavaScript code as an async function and return automatically.",
      aliases: ["frev"],
      quotes: [],
    });
  }
  ...
  public async messageRun(message: Message, args: Args) {
    ...
    try {
      const result = await evalWithUtils(code, message, "fr");
